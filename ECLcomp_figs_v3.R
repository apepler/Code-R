...
legend("topright",lwd=4,col=colors,legend=c("MLD","LAPB","LAPM","PG","GV 48hr","GV 12hr"),ncol=2)
...
legend("bottomright",lwd=4,col=colors,legend=c("MLD","LAPB","LAPM","PG","GV"),ncol=2)
...
tiff(file="Fig7_v3.tiff",height=600,width=500)
