...
for(r in 1:3)
{
  ...
  a=open.nc(paste("/srv/ccrc/data45/z3478332/WRF/output/ERAI_R",r,"_nudging_default_2007_BRAN_2eac/out/ECLslp_0708_",cat[c],"_v2.nc",sep=""))
  slp_2eac[[n]]=var.get.nc(a,"ECL_slp")
  gv_2eac[[n]]=var.get.nc(a,"ECL_gv")
  a=open.nc(paste("/srv/ccrc/data45/z3478332/WRF/output/ERAI_R",r,"_nudging_default_2007_BRAN_2eac/out/ECLrain_0708_",cat[c],"_v2_centred.nc",sep=""))
  rain_2eac[[n]]=var.get.nc(a,"ECLrain")
  a=open.nc(paste("/srv/ccrc/data45/z3478332/WRF/output/ERAI_R",r,"_nudging_default_2007_BRAN_2eac/out/ECLwind_d01_0708_",cat[c],"_v2.nc",sep=""))
