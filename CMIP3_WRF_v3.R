...
W_pfile=paste("/srv/ccrc/data36/z3478332/CMIP3/WRF_R",r,"_",name2[n],"_precip_noregrid.nc",sep="")
#corrlist[count,1]=paste(name2[n]," R",r,sep="")

fig2a=paste("Rain_corrUwind_sig_",name[n],"_WRFR",r,"_cool_postgrid.tiff",sep="")
fig3a=paste("Rain_corrUwind_sig_",name[n],"_WRFR",r,"_warm_postgrid.tiff",sep="")
fig2=paste("Rain_corrUwind_",name[n],"_WRFR",r,"_cool_postgrid.tiff",sep="")
fig3=paste("Rain_corrUwind_",name[n],"_WRFR",r,"_warm_postgrid.tiff",sep="")
print(name[n])
...
save(coolA,coolA1,warmA,warmA1,file="WRF50corrs.RData")
...
fig2a=paste("Rain_corrUwind_sigdot_CMIP3_WRF_median_cool_postregrid.tiff",sep="")
fig3a=paste("Rain_corrUwind_sigdot_CMIP3_WRF_median_warm_postregrid.tiff",sep="")
fig2=paste("Rain_corrUwind_CMIP3_WRF_median_cool_postregrid_small.tiff",sep="")
fig3=paste("Rain_corrUwind_CMIP3_WRF_median_warm_postregrid_small.tiff",sep="")
...
tiff(file=fig2a, height=1000, width=1100, pointsize=20)
...
dev.off()
tiff(file=fig3a, height=1000, width=1100, pointsize=20)
...
fig2a=paste("Rain_corrUwind_sig_",name[n],"_WRF_median_cool_postregrid.tiff",sep="")
fig3a=paste("Rain_corrUwind_sig_",name[n],"_WRF_median_warm_postregrid.tiff",sep="")
fig2=paste("Rain_corrUwind_",name[n],"_WRF_median_cool_postregrid.tiff",sep="")
fig3=paste("Rain_corrUwind_",name[n],"_WRF_median_warm_postregrid.tiff",sep="")
...
data=read.csv("/home/nfs/z3478332/Documents/Data/CMIP5/CMIP3/20c3m/newcomp_wrf50_postregrid.csv")
...
for(i in 1:5)
{
  fname=paste("~/Documents/Data/CMIP5/CMIP3/20c3m/WRF50/akima regrid/Corrs_scatter_",name[i],"_v5.tiff",sep="")
tiff(file=fname,height=600,width=600,pointsize=20)
plot(data[2:5,a[i]],data[2:5,b[i]],type="p",col="gray50",pch=19,xlab="Coastal correlation",ylab="Inland correlation",xlim=c(-0.7,0.2),ylim=c(-0.7,0.7))
abline(h=0,col="grey")
abline(v=0,col="grey")
points(data[6:17,a[i]],data[6:17,b[i]],col="grey",pch=17)
points(data[1,a[i]],data[1,b[i]],col="black",pch=4,cex=2,lwd=4)
points(median(data[2:5,a[i]]),median(data[2:5,b[i]]),col="gray50",pch=1,cex=2,lwd=4)
points(median(data[6:17,a[i]]),median(data[6:17,b[i]]),col="grey",pch=2,cex=2,lwd=4)
