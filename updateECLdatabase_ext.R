...
ECLdatabase<-function(yearS,yearE,output)
{
  ...
  fixes[,11]<-0
  I<-which(fixes[,6]>=149 & fixes[,6]<=170 & fixes[,7]<(-37) & fixes[,7]>=-43)
  fixes[I,11]<-1
  I<-which(fixes[,6]>=(149+(37+fixes[,7])/2) & fixes[,6]<=170 & fixes[,7]<(-31) & fixes[,7]>=-37)
  fixes[I,11]<-1
  I<-which(fixes[,6]>=152 & fixes[,6]<=170 & fixes[,7]<=(-22) & fixes[,7]>=-31)
  fixes[I,11]<-1
  ...
  fixesDJF[,11]<-0
  I<-which(fixesDJF[,6]>=149 & fixesDJF[,6]<=170 & fixesDJF[,7]<(-37) & fixesDJF[,7]>=-41)
  fixesDJF[I,11]<-1
  I<-which(fixesDJF[,6]>=(149+(37+fixesDJF[,7])/2) & fixesDJF[,6]<=170 & fixesDJF[,7]<(-31) & fixesDJF[,7]>=-37)
  fixesDJF[I,11]<-1
  I<-which(fixesDJF[,6]>=152 & fixesDJF[,6]<=170 & fixesDJF[,7]<=(-24) & fixesDJF[,7]>=-31)
  fixesDJF[I,11]<-1
  ...
  I<-which(events[,7]>1 & floor(events[,3]/10000)>yearS)
  ...
  outF=paste('ECLfixes_',output,'_ext.csv',sep="")
  outE=paste('ECLevents_',output,'_ext.csv',sep="")
