...
#Table 2
warm=read.csv('events_warm_rad2.csv')
cool=read.csv('events_cool_rad2.csv')
#warm=warm[,-6]
#cool=cool[,-6]
...
write.csv(corrs,file='table2.csv')
...
##Figure 2
data=read.csv('duration2_rad2.csv')
#data=data[,-6]
...
legend("topright",lwd=4,col=colors,legend=c("MLD","LAPB","LAPM","PG","GV 48hr","GV 12hr"))

#Figure 3
data=read.csv('season_rad2.csv')
#data=data[,-6]
...
#Figure 4
data=read.csv('seasonB_rad2.csv')
...
library(ggplot2)
tiff(file=paste("Fig5_v2.tiff",sep=""), height=400, width=800,pointsize=20)
...
#Figure 6
data1=read.csv('HR_days_rad2.csv')
data2=read.csv('HR_mslp_rad2.csv')
#data1=data1[,-6]
#data2=data2[,-6]
plot.new()
...
tiff(file="Fig7_rad2.tiff",height=600,width=500)
...
contour(Useful$x,Useful$y,mask,drawlabels=F,xlim=c(140,165),ylim=c(-45,-20))
...
legend("bottomleft",col=colors[1:4],legend=c("MLD","LAPB","LAPM","PG"),pch=rep(4,4),pt.lwd=rep(4,4))
