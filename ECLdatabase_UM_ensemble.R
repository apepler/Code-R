...
ECLdatabase<-function(yearS,yearE,output,member,outdir="")
{
...
rm(fixesDEC)
  ...
  outF=paste(outdir,'ECLfixes_',output,'_',member,'.csv',sep="")
  outE=paste(outdir,'ECLevents_',output,'_',member,'.csv',sep="")
