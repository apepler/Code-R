...
postscript(file="~/Documents/Data/CMIP5/Figure3.eps", height=5, width=8)
...
data=data[-c(1,2,3),]
postscript(file="~/Documents/Data/CMIP5/Figure5.eps",height=6,width=6,pointsize=20)
par(mar=c(4,4,2,2))
a=6
b=5
...
points(mean(data[2:38,a]),mean(data[2:38,b]),col="black",pch=1,cex=2,lwd=4)
dev.off()
...
##Let's stick with 2.5 for now
data=data[-c(1,2,3),]
cmip=apply(data[2:38,5:10],2,mean)
...
a=11
b=10
fname="~/Documents/Data/CMIP5/CMIP3/20c3m/WRF10/Figure10.eps"
par(mar=c(4,4,2,2))
postscript(file=fname,height=6,width=6,pointsize=20)
...
points(mean(data1[2:5,a]),mean(data1[2:5,b]),col="gray50",pch=1,cex=2,lwd=4)
points(mean(data1[6:17,a]),mean(data1[6:17,b]),col="gray65",pch=2,cex=2,lwd=4)
points(mean(data2[6:17,a]),mean(data2[6:17,b]),col="gray80",pch=0,cex=2,lwd=4)
...
postscript(file="Figure9.eps", height=7, width=18, pointsize=20)
...
sigmask50=which(abs(cool50)>=0.45,arr.ind=T)
I=which(lon50[sigmask50[,1]]>160 | lon50[sigmask50[,1]]<110)
...
postscript(file="Figure8.eps", height=7, width=18, pointsize=20)
layout(cbind(1,2,3), width=c(1.1,1,0.3),height=1)
par(mar=c(5,5,1,1)+0.1)
...
postscript(file="Figure7.eps", height=7, width=11, pointsize=20)
...
postscript(file="Figure6.eps", height=7, width=11, pointsize=20)
layout(cbind(1,2), width=c(1.1,0.3),height=1)
par(mar=c(3,3,1,1)+0.1)
...
postscript(file="Figure4_all2.eps", height=14, width=18,pointsize=20)
...
postscript(file="Figure2_anoms.eps", height=7, width=18, pointsize=20)
layout(cbind(1,2,3), width=c(1.1,1,0.3),height=1)
par(mar=c(5,5,1,1)+0.1)
...
postscript(file="Figure2_PCchange_v2.eps", height=7, width=18, pointsize=20)
layout(cbind(1,2,3), width=c(1.1,1,0.3),height=1)
par(mar=c(5,5,1,1)+0.1)
...
breaklist=c(-1000,-200,-150,-100,-50,-25,-10,0,10,25,50,100,150,200,1000)
postscript(file="Figure2_combo.eps", height=7, width=18, pointsize=20)
layout(cbind(1,2,3), width=c(1.1,1,0.3),height=1)
par(mar=c(5,5,1,1)+0.1)
...
postscript(file="Figure2_normchange_v2.eps", height=7, width=18, pointsize=20)
layout(cbind(1,2,3), width=c(1.1,1,0.3),height=1)
par(mar=c(5,5,1,1)+0.1)
